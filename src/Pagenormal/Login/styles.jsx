...
export const ContainerCompleto = styled.div`
  ...
  @media (max-width: 768px) {
    padding: 0.5rem;
    max-width: 100%; /* Ocupa a largura completa em dispositivos móveis */
  }
...
export const H2Login = styled.h2`
  ...
  @media (max-width: 768px) {
    font-size: 1.5rem; /* Ajuste da fonte para celular */
    margin-top: 1rem;
  }
`;
...
export const ButtonLogin = styled.button`
  ...
  &:hover {
    background-color: #4540d2;
  }

  @media (max-width: 768px) {
    font-size: 0.75rem; /* Ajuste da fonte para celular */
